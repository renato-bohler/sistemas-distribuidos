...
-- Accommodation
INSERT INTO Accommodation (id, cidade, dataEntrada, dataSaida, numeroQuartos, numeroPessoas, precoPorQuarto, precoPorPessoa) VALUES (1, 'São Paulo', CURRENT_TIMESTAMP, DATEADD('DAY',1, CURRENT_DATE), 50, 400, 50, 80);